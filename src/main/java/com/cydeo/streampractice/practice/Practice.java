...
public class Practice {
    ...
    public static boolean checkIfThereIsNoSalaryLessThan1000() {
        //TODO Implement the method
        return getAllEmployees().stream()
               // .allMatch(employee -> employee.getSalary() >1000);// все зарплаты выше 1000 - true
                .noneMatch(employee -> employee.getSalary() <1000); // ни одна зарплата не меньше 1000 - TRUE
                //.anyMatch(employee -> employee.getSalary() < 1000); // есть хоть одна ЗП меньше 1000 - FALSE
...
/*
                ...
                .filter(employee-> {
                    try {
                        return employee.getSalary().longValue()!=getMaxSalary();
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                })
...
*/
    ...
    public static Map<Long, List<Employee>> getAllEmployeesForEachDepartment() {
        ...
        //.mapToLong(employee -> employee.getDepartment().getId().longValue())
        //.collect(Collectors.toMap())
        //getAllEmployees().stream()

        //.collect(Collectors.groupingBy(departmentService.readById(departmentService.readAll().get(1).getId()), Employee::getDepartment ));
        // .collect(Collectors.toMap(Employee::getId,employee -> employeeService.readAll()));
    ...
    public static List<String> getAllEmployeesInitials() {
        ...
        return getAllEmployees().stream()
                .map(employee -> {
                    String initialF = employee.getFirstName().substring(0,1);
                    String initialL = employee.getLastName().substring(0,1);
